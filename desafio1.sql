DROP DATABASE IF EXISTS SpotifyClone;
  ...
  CREATE TABLE SpotifyClone.albuns(
    ...
    CREATE TABLE SpotifyClone.cancoes(
      id INT PRIMARY KEY AUTO_INCREMENT,
      titulo_cancao VARCHAR(70) NOT NULL,
  ...
  INSERT INTO SpotifyClone.albuns (titulo_album, lancamento, artista_id)
  VALUES
    ('Renaissance', 2022, 1),
    ('Jazz', 1978, 2),
    ('Hot Space', 1982, 2),
  ...
  INSERT INTO SpotifyClone.cancoes (titulo_cancao, duracao_segundos, artista_id, album_id)
  VALUES
